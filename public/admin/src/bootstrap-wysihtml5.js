    ...
    var tpl = {
        "font-styles": function(locale, options) {
            ...
            return "<li class='dropdown'>" +
              "<a class='btn btn-default" + size + "' data-toggle='dropdown' href='#'>" +
        ...
        "link": function(locale, options) {
            var size = (options && options.size) ? ' btn-'+options.size : '';
            return "<li>" +
            "<button data-toggle='modal' data-target='.bs-link' class='btn btn-default" + size + "' data-wysihtml5-command='createLink' title='" + locale.link.insert + "' tabindex='-1'><i class='fa fa-external-link'></i></button>" +
              "<div class='modal fade bs-link ' tabindex='-1' role='dialog' aria-labelledby='myModalLabel' aria-hidden='true'>" +
        ...
        "image": function(locale, options) {
            var size = (options && options.size) ? ' btn-'+options.size : '';
            return "<li>" +
            "<button data-toggle='modal' data-target='.bs-example' class='btn btn-default" + size + "' data-wysihtml5-command='insertImage' title='" + locale.image.insert + "' tabindex='-1'><i class='fa fa-file-image-o'></i></button>" +
              "<div class='modal fade bs-example' tabindex='-1' role='dialog' aria-labelledby='myModalLabel' aria-hidden='true'>" +
              "<div class='modal-dialog modal-sm'>"+
              "<div class='modal-content'>"+
                "<div class='modal-header'>" +
                  "<a class='close' data-dismiss='modal'>&times;</a>" +
                ...
                "<div class='modal-footer'>" +
                  ...
                  "<ahref='#' class='btn btn-primary' data-dismiss='modal'>" + locale.image.insert + "</a>" +
                "</div>" +
              "</div>" +
              "</div>"+
              "</div>"+
